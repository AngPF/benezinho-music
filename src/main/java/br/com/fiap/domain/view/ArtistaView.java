...
public class ArtistaView implements View<Artista, Long>{
    ...
    public Artista findById(Long id) {
        ...
        do {identificador = Long.valueOf(JOptionPane.showInputDialog("Id do Artista"));
    ...
    public Artista persist(Artista artista) {
        ...
        do{
            nome = JOptionPane.showInputDialog("Nome do artista Musical", Objects.nonNull( artista) && Objects.nonNull(artista.getNome())? artista.getNome(): "");
        }while (!service.valido(nome));

        Artista a = new Artista();
        a.setNome(nome);
        if (Objects.nonNull(artista)) && Objects.nonNull((artista.getId()));
